...
export default function Legend({languages}) {
    ...
    return <div key = {"legend"}  className="   lg:m-10 right-0 top-0 m-2 z-40 h-fit border border-black bg-slate-300 rounded grid  dark:bg-gray-400 dark:text-slate-800" >
